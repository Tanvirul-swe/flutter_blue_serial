...
public class FlutterBlueSerialPlugin implements FlutterPlugin, ActivityAware {
    ...
    public FlutterBlueSerialPlugin() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (Objects.requireNonNull(action)) {
                    case BluetoothDevice.ACTION_FOUND:
                        final BluetoothDevice device = intent.getParcelableExtra(BluetoothDevice.EXTRA_DEVICE);
                        final BluetoothClass deviceClass = intent.getParcelableExtra(BluetoothDevice.EXTRA_CLASS);
                        ...
                        discoveryResult.put("deviceType", deviceClass.getMajorDeviceClass());
    ...
    private class FlutterBluetoothSerialMethodCallHandler implements MethodCallHandler {
        ...
        public void onMethodCall(@NonNull MethodCall call, @NonNull MethodChannel.Result result) {
            ...
            methodCallDispatching: switch (call.method) {
                ...
                case "requestEnable":
                    System.out.println("requestEnable " + bluetoothAdapter.isEnabled());
                ...
                case "requestDisable":
                    ...
                    System.out.println("requestDisable " + bluetoothAdapter.isEnabled());
                ...
                case "removeDeviceBond": {
                    ...
                    switch (device.getBondState()) {
                        ...
                        case BluetoothDevice.BOND_NONE:
                            result.error("bond_error", "device already unbounded", null);
                            break methodCallDispatching;
                        default:
                            // Proceed.
                            break;
                    ...
                    try {
                        ...
                        result.error("bond_error", "error while unbinding", exceptionToString(ex));
                    }
                    break;
                }
                ...
                case "pairingRequestHandlingEnable":
                    if (FlutterBlueSerialPlugin.this.isPairingRequestHandlerSet) {
                ...
                case "pairingRequestHandlingDisable":
                    FlutterBlueSerialPlugin.this.isPairingRequestHandlerSet = false;
                    try {
